...
export const movieListThunk = createAsyncThunk('movie/list', async ({status, limit, cursor}: MovieListArg, { rejectWithValue }) => {
    try {
...
export const movieDetailThunk = createAsyncThunk('movie/detail', async (id: string, { rejectWithValue }) => {
    try {
